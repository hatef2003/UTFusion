...
void CamData::find_closest_point_in_box(uint16_t ulx, uint16_t uly, uint16_t brx, uint16_t bry) // up left x and y, bottom right x and y
{
...
CamData::CamData(uint8_t _len_imageboxes) {
